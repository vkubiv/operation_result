...
void main() {
  group('operation_result4', () {
    test('should return success', () {
      final result = success5(10);
      ...
      final forwarded = result.forward5(success: (val) => 'val: $val');
    ...
    test('should return failure', () {
      final Result<int, Errors5<Failure1, Failure2, Failure3, Failure4, Failure5>> result = failure5(Failure1('error'));
    ...
    test('should return multiple failures', () {
      final Result<int, Errors5<Failure1, Failure2, Failure3, Failure4, Failure5>> result =
          failures5([Failure1('error1'), Failure1('error2')]);
    ...
    test('forward failed result', () {
      ...
      final forwarded = result.forward5(failure: (e) => e);
    ...
    test('forward unspecified error', () {
      Result<int, Errors5<Failure1, Failure2, Failure3, Failure4, Failure5>> testFunc() {
        final result = failure5(UnspecifiedFailure('error'));
        return result.forward5(failure: (e) => e);
      }
    ...
    test('both failure and success parameters missed for forward1 function', () {
      final result = failure5(Failure1('error'));

      expect(() {
        return result.forward5();
    ...
    test('failure parameter missed for forward1 function in case of operation failure', () {
      Result<int, Errors5<Failure1, Failure2, Failure3, Failure4, Failure5>> testFunc() {
        final result = failure5(UnspecifiedFailure('error'));
        return result.forward5(success: (val) => val);
      }
