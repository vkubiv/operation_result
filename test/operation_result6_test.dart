...
void main() {
  group('operation_result4', () {
    test('should return success', () {
      ...
      final forwarded = result.forward6(success: (val) => 'val: $val');
    ...
    test('should return multiple failures', () {
      final Result<int, Errors6<Failure1, Failure2, Failure3, Failure4, Failure5, Failure6>> result =
          failures6([Failure1('error1'), Failure1('error2')]);
    ...
    test('forward unspecified error', () {
      Result<int, Errors6<Failure1, Failure2, Failure3, Failure4, Failure5, Failure6>> testFunc() {
        final result = failure6(UnspecifiedFailure('error'));
        return result.forward6(failure: (e) => e);
      }
    ...
    test('both failure and success parameters missed for forward1 function', () {
      final result = failure6(Failure1('error'));

      expect(() {
        return result.forward6();
    ...
    test('failure parameter missed for forward1 function in case of operation failure', () {
      Result<int, Errors6<Failure1, Failure2, Failure3, Failure4, Failure5, Failure6>> testFunc() {
        final result = failure6(UnspecifiedFailure('error'));
        return result.forward6(success: (val) => val);
      }
