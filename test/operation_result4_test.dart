...
void main() {
  group('operation_result4', () {
    test('should return success', () {
      ...
      final forwarded = result.forward4(success: (val) => 'val: $val');
    ...
    test('should return failure', () {
      final Result<int, Errors4<Failure1, Failure2, Failure3, Failure4>> result = failure4(Failure1('error'));
    ...
    test('should return multiple failures', () {
      final Result<int, Errors4<Failure1, Failure2, Failure3, Failure4>> result =
          failures4([Failure1('error1'), Failure1('error2')]);
    ...
    test('forward failed result', () {
      ...
      final forwarded = result.forward4(failure: (e) => e);
    ...
    test('forward unspecified error', () {
      Result<int, Errors4<Failure1, Failure2, Failure3, Failure4>> testFunc() {
        final result = failure4(UnspecifiedFailure('error'));
        return result.forward4(failure: (e) => e);
      }
    ...
    test('both failure and success parameters missed for forward1 function', () {
      final result = failure4(Failure1('error'));

      expect(() {
        return result.forward4();
    ...
    test('failure parameter missed for forward1 function in case of operation failure', () {
      Result<int, Errors4<Failure1, Failure2, Failure3, Failure4>> testFunc() {
        final result = failure4(UnspecifiedFailure('error'));
        return result.forward4(success: (val) => val);
      }
